...
from sagin_research_sim.radio.satellite_radio import make_satellite_radio
...
class Satellite(NetworkNode):
    def __init__(self, uuid: str, local_id: int, position: Position, radio: Optional[RadioConfig] = None):
        super().__init__(
            ...
            position=position,
            radio=radio or make_satellite_radio(),
            compute_capacity_cycles_per_s=EdgeComputeConfig().satellite_compute_capacity_cycles_per_s,
        )
